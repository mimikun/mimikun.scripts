...
for cmd in "chezmoi" "flyctl" "runme" "bin" "mise" "luarocks" "gopass" "glow" "pnpm" "aqua" "berg" "sunbeam" "gitleaks" "lefthook" "nvs" "sake" "mani" "turm" "pass-cli" "envdiff" "autohand" "acli" "goose" "kiro-cli" "taws"; do
    if command_exist "${cmd}"; then
